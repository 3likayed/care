...
import { a as _sfc_main$1 } from "../app.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    let localesCount = usePage().props.locales.length;
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="${ssrRenderClass(`grid gap-x-5 grid-cols-${((_a = __props.cols) == null ? void 0 : _a.sm) ?? "1"} lg:grid-cols-${((_b = __props.cols) == null ? void 0 : _b.lg) ?? unref(localesCount)}`)}">`);
