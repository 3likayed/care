...
import { b as _sfc_main$5, _ as _sfc_main$8, a as _sfc_main$9 } from "./NavigationsList-a5879dfa.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    let steps = ref([__("data"), __("children")]);
    let step = ref(0);
    let navigation = usePage().props.navigation.data;
    let showCreateNavigation = ref(false);
    provide("showCreateNavigation", showCreateNavigation);
    let breadcrumbItems = [
      {
        name: __("navigations"),
        href: route("dashboard.navigations.index")
      },
      {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$5, { navigation: unref(navigation) }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(_sfc_main$8, {
              navigations: unref(navigation).children
            ...
            return [
              ...
              withDirectives(createVNode("section", null, [
                createVNode(_sfc_main$5, { navigation: unref(navigation) }, null, 8, ["navigation"])
              ], 512), [
                [vShow, unref(step) === 0]
              ]),
              withDirectives(createVNode("section", null, [
      ...
      _push(ssrRenderComponent(_sfc_main$9, { navigation: unref(navigation) }, null, _parent));
      _push(`<!--]-->`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/Dashboard/js/Pages/Navigations/Show.vue");
