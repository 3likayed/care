...
import { m as modelResolver } from "../app.js";
import "@mdi/js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$2, {
              items: [{ name: _ctx.__(`${unref(modelResolver)(unref(model))}`), href: _ctx.route(`dashboard.${unref(modelResolver)(unref(model))}.index`) }]
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/Dashboard/js/Pages/AppointmentTypes/Index.vue");
