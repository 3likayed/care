<template>
  <CardBoxModal
    ...
    <FormField>
      <FormCheckRadioGroup :label="__('role')" label-for="role">
        <FormCheckRadio v-for="(role,key) in roles"
                        :key="key"
                        v-model="form.role"
...
import {mdiAccount, mdiFormTextboxPassword, mdiHome, mdiPhone} from "@mdi/js";
